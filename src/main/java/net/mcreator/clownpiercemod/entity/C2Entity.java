...
package net.mcreator.clownpiercemod.entity;
...
import net.mcreator.clownpiercemod.procedures.ClownPierceEntityDiesProcedure;
...
public class C2Entity extends Monster {
	...
	public C2Entity(PlayMessages.SpawnEntity packet, Level world) {
		this(ClownpierceModModEntities.C_2.get(), world);
	}
	...
	public C2Entity(EntityType<C2Entity> type, Level world) {
		...
		xpReward = 16;
		setNoAi(false);
		setCustomName(Component.literal("ClownPierce"));
		setCustomNameVisible(true);
		this.setItemSlot(EquipmentSlot.MAINHAND, new ItemStack(ClownpierceModModItems.SCYTHE.get()));
	...
	protected void dropCustomDeathLoot(DamageSource source, int looting, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(new ItemStack(ClownpierceModModItems.SCYTHE.get()));
	}
	...
	public void die(DamageSource source) {
		super.die(source);
		ClownPierceEntityDiesProcedure.execute(this.level());
	}
